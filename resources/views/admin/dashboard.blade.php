        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-red-100 p-4 rounded-lg shadow-inner text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <a href="{{ route('admin.manage-users') }}" class="block bg-white shadow-md rounded-lg p-6 text-center hover:bg-gray-100 transition duration-200 ease-in-out">
                ...
                <a href="{{ route('admin.manage-pets') }}" class="block bg-white shadow-md rounded-lg p-6 text-center hover:bg-gray-100 transition duration-200 ease-in-out">
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Total Pets</h3>
                    <p class="text-3xl font-bold text-gray-800">{{ $petsCount }}</p>
                </a>

                <!-- Gerenciamento de Eventos -->
                <a href="{{ route('admin.manage-events') }}" class="block bg-white shadow-md rounded-lg p-6 text-center hover:bg-gray-100 transition duration-200 ease-in-out">
                ...
                <a href="{{ route('admin.manage-forms') }}" class="block bg-white shadow-md rounded-lg p-6 text-center hover:bg-gray-100 transition duration-200 ease-in-out">
