    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-4 lg:px-6">
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <!-- Formulário para editar e salvar o conteúdo da Política -->
                <form action="{{ route('admin.policy.update') }}" method="POST">
                    @csrf

                    <!-- Campo para o Título -->
                    <div class="mb-4">
                        <label for="title" class="form-label">Versão da Política de Privacidade</label>
                    ...
                    <!-- Editor de Política (Summernote) -->
                    <div class="mb-4">
                        <label for="policyEditor" class="form-label">Conteúdo da Política de Privacidade</label>
